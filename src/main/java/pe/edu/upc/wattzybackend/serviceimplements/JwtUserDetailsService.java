...
public class JwtUserDetailsService implements UserDetailsService {
    ...
    @Override
    public UserDetails loadUserByUsername(String username) throws UsernameNotFoundException {
        Usuarios user = repo.findByCorreo(username);
        ...
        */
        roles.add(new SimpleGrantedAuthority(repo.obtenerNombreRolPorEmail(username)));

        UserDetails ud = new org.springframework.security.core.userdetails.User(user.getCorreo(), user.getPassword(), user.isEstado(), true, true, true, roles);
